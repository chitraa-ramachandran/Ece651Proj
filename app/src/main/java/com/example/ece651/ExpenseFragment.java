...
public class ExpenseFragment extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Data,MyViewHolder> adapter=new FirebaseRecyclerAdapter<Data, MyViewHolder>(Data.class,R.layout.expense_recycler_data,MyViewHolder.class,mExpenseDatabase) {
            @Override
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        {
            TextView mDate=mView.findViewById(R.id.date_txt_expense);//name got from incomerecycler xml
            mDate.setText(date);
        }
        private void setAmount(Integer amount)
        {
            TextView mAmount=mView.findViewById(R.id.amount_txt_expense);//name got from incomerecycler xml
    ...
    private void updateDataItem()
    {
        ...
        edtType=myview.findViewById(R.id.note_edt);
